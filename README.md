# 주식 자산 AI 관리 플랫폼 - RichClub

> 본 프로젝트는 개발 포트폴리오 데모 목적으로 제작되었습니다. AI 예측 결과는 참고용이며 실제 투자 조언이 아닙니다. 투자자문업 등록 또는 유사투자자문업 신고를 하지 않은 데모 서비스이므로 실제 투자 결정에 활용하지 마시기 바랍니다. 과거 AI 예측 성과가 미래 수익을 보장하지 않습니다.
